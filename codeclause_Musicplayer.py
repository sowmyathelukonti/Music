...
# icon
image_icon = PhotoImage(file="C:\\Users\\hp 4021\\Music\\logo.png")
root.iconphoto(False, image_icon)

TOP = PhotoImage(file="C:\\Users\\hp 4021\\Music\\top.png")
Label(root, image=TOP, bg="#0f1a2b").pack()

# logo
Logo = PhotoImage(file="C:\\Users\\hp 4021\\Music\\logo.png")
Label(root, image=Logo, bg="#0f1a2b").place(x=65, y=115)

# button
play_button = PhotoImage(file="C:\\Users\\hp 4021\\Music\\play.png")
Button(root, image=play_button, bg="#0f1a2b", bd=0, command=play_song).place(x=100, y=400)

stop_button = PhotoImage(file="C:\\Users\\hp 4021\\Music\\stop.png")
Button(root, image=stop_button, bg="#0f1a2b", bd=0, command=mixer.music.stop).place(x=30, y=500)

resume_button = PhotoImage(file="C:\\Users\\hp 4021\\Music\\resume.png")
Button(root, image=resume_button, bg="#0f1a2b", bd=0, command=mixer.music.unpause).place(x=115, y=500)

pause_button = PhotoImage(file="C:\\Users\\hp 4021\\Music\\pause.png")
...
# music
Menu = PhotoImage(file="C:\\Users\\hp 4021\\Music\\menu.png")
